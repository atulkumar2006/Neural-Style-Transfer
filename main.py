    ...
    def run_transfer(self):
        ...
        def task():
            try:
                ...
                output_filename = f"outputs/output_{timestamp}.jpg"
                output = stylize(self.content_path, self.style_path, output_path=output_filename)
                self.output_path = output_filename

                self.display_image(self.output_path, self.output_img_panel, (300, 300))
